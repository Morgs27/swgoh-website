    ...
    <div id = "discord" onmouseout = 'deactive_filter(this.id)' class="filter_main left">
        ...
        <div class="filter_sub_container">
            ...
            <div id = 'AhnaldT101' onclick = 'toggle_sub(this.id)' class="filter_sub">
                <img src = 'https://cdn.discordapp.com/icons/223633352576598016/a_9c0ff11e59bc6901361c8bd80a72a4c7.webp?size=240'>
        ...
        foreach ($posts as $post){
            ...
            if ($post['Type'] == "Reddit"){
                ...
                if ($post['Server'] == 'SWGOH Events'){
                    ...
                    $server_img = "https://cdn.discordapp.com/icons/223633352576598016/a_9c0ff11e59bc6901361c8bd80a72a4c7.webp?size=240";
